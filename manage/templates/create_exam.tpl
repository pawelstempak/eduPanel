  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
		<div class="section">
			...
			<div class="row">
				<div class="col l6">
				<h4 class="grey-text text-darken-2">Utwórz nowy test</h4>
				</div>
				<div class="col l6 right-align">
				<div class="right"><button class="btn waves-effect waves-light btn red" onclick="location='exams'">Zamknij</button></div>
				...
				<div><button class="btn waves-effect waves-light btn" type="submit" name="save">Zapisz</button></div>
				  ...
				  <div class="input-field">
				    ...
				    <label>Wybierz kurs do jakiego przypisać test.</label>
				  </div>
		        <div class="input-field">
		        ...
		        <div class="input-field">
			          <textarea name="description" class="materialize-textarea" {* id="tinymcetextarea" *}></textarea>
