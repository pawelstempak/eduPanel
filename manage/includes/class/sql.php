...
class sql
{
	...
	{
		global $cfg;
		$this->db = mysqli_connect($cfg['database_url'], $cfg['database_login'], $cfg['database_password']) or die ("<center>Serwis chwilowo niedostepny.<br>Za utrudnienia przepraszamy.<br> Zapraszamy za chwile.</center>");
		mysqli_select_db($this->db,$cfg['database_name']);
